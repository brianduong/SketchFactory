...
const strokes: DrawingStroke[] = [
  ...
  },
  {
    ...
    startMs: 14500, durationMs: 1400, stepId: "step-4", voiceDescription: "Add a tiny nose.", enabled: true,
  },
  {
    id: "07-mouth", name: "Draw the mouth", order: 7, geometry: "path",
    vector: { d: "M500 605 Q465 650 430 615 M500 605 Q535 650 570 615" },
    bounds: { x: 430, y: 605, width: 140, height: 45 }, startMs: 16600, durationMs: 1900,
  ...
  },
  {
    ...
    bounds: { x: 240, y: 555, width: 520, height: 70 }, startMs: 19300, durationMs: 2500,
...
const cues: VoiceCue[] = [
  { id: "hook", startMs: 200, endMs: 2500, text: "Can you draw a cat in just eight strokes?" },
  ...
  { id: "step-4", startMs: 14200, endMs: 19000, text: steps[3]!.voiceText },
  { id: "step-5", startMs: 19000, endMs: 22000, text: steps[4]!.voiceText },
